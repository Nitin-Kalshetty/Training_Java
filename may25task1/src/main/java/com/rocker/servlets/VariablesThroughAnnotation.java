 ...
 */
@WebServlet(urlPatterns = "/variablesThroughAnnotation",initParams = {@WebInitParam(name = "variable1",value = "I am variable 1"),@WebInitParam(name = "variable2",value = "I am variable 2")})
